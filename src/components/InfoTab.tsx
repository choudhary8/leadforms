export const InfoTab=()=>{
    return (
        <div className="w-1/2 py-6 px-10">
            ...
            <div className="bg-[#d75b15] font-semibold text-2xl text-white p-6 mb-4">Share your banking experience with your NRI family and friends</div>
            ...
            <div className="actionInfo my-2 ">
                <div className="flex items-center w-2/3">
                    ...
                    <div className="p-2 px-4">
                        ...
                        <div>Fill the form and get your family and friends on-call assistance for NRI account opening.</div>
                    </div>
                </div>
            ...
            <div className="actionInfo my-2 flex items-center">
                ...
                <div className="p-2 px-4">
                    ...
                    <div className="w-2/3">ICICI Bank will call and assist in filling the Account Opening form and KYC documentation.</div>
                </div>
            </div>
            ...
            <div className="actionInfo my-2">
                <div className="flex items-center w-2/3">
                    ...
                    <div className="p-2 px-4">
                        ...
                        <div>Account is opened after successful scrutiny of KYC documents.</div>
                    </div>
                </div>
